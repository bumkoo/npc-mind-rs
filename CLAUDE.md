...
# chat feature 환경변수
# NPC_MIND_CHAT_URL=http://127.0.0.1:8081/v1   (로컬 추론 서버 URL, 기본값)
# NPC_MIND_CHAT_MODEL=local-model               (모델 이름, 기본값)
```
...
mcp/
  mind_studio_server.py             # MCP 서버 — Mind Studio API 23개 도구 노출 (Python + mcp SDK)
