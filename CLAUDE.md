...
- **Phase 2.3 spec (초안)**: [`docs/tasks/mind-architecture/task-rel-phase2.3-appraise-tuning.md`](docs/tasks/mind-architecture/task-rel-phase2.3-appraise-tuning.md) — 🟡 DRAFT (헤더 + 범위 골격만, Phase 2.3 진입 시 본체 작성).
