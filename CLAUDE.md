...
cargo test --test pad_benchmark_test      # PAD 앵커 정확도 벤치마크
cargo test --test pad_anchor_count_bench  # PAD 앵커 개수별 성능 비교
cargo test --test pad_colbert_bench       # ColBERT 스코어링 벤치마크
cargo test --test pad_gemini_bench        # Gemini 임베딩 벤치마크
cargo test --test pad_individual_scores   # PAD 개별 감정 스코어 분석
