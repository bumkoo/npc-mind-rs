...
**산출물 spec**: sub-stage별 작성 — 2.4.0 [phase2.4.0-hexaco-double-application-review.md](phase2.4.0-hexaco-double-application-review.md) / 2.4.1 [task-rel-phase2.4.1-intensity-weight.md](task-rel-phase2.4.1-intensity-weight.md) / 2.4.2 [task-rel-phase2.4.2-base-delta.md](task-rel-phase2.4.2-base-delta.md) 모두 🟢. 2.4.3·2.4.4 미작성 (진입 시).
